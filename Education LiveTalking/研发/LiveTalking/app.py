...
from llm import llm_response as _original_llm_response
from llm_rag import llm_rag_response
import registry
...
def main():
    ...
    appasync["llm_response"] = llm_rag_response  # RAG增强模式; 降级为原版用 _original_llm_response
    appasync["opt"] = opt
