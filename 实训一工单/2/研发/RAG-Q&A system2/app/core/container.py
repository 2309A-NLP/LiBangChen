...
from app.services.document_tasks import DocumentTaskService
...
class AppContainer:
    ...
    def __init__(
        ...
        self.document_task_service = document_task_service
    ...
    def build(cls) -> "AppContainer":
        ...
        document_ingestion_service = DocumentIngestionService(settings, ocr_service=ocr_service)
