...
def test_embedding_service_uses_local_model_path(monkeypatch):
    ...
    service = EmbeddingService(
        Settings(
            embedding_model_name=r"C:\Users\26332\.cache\modelscope\hub\models\BAAI\bge-m3",
    ...
    assert captured["model_name"] == r"C:\Users\26332\.cache\modelscope\hub\models\BAAI\bge-m3"
