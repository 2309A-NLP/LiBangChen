...
class DocumentIngestionService:
    ...
    def _build_doubao_page_prompt(self, file_name: str, page_number: int) -> str:
        return (
            ...
            "For charts, diagrams, flowcharts, organization charts, pie charts, bar charts, "
            "and line charts, write searchable descriptions including title, chart type, "
            "axes or legend, categories, values or proportions, trends, and relationships. "
            "When numeric labels are visible, preserve them verbatim. "
